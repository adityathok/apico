...
<template>
    ...
    <main
        class="flex min-h-screen items-center justify-center bg-[url('https://images.unsplash.com/photo-1500491460312-c32fc2dbc751?q=80&w=2400&auto=format&fit=crop')] px-6 py-10"
    >
